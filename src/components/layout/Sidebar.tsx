...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 z-30 flex h-full w-64 flex-col border-r border-slate-700/60 bg-slate-900 transition-transform duration-300 lg:static lg:translate-x-0 lg:z-auto',
      ...
      >
        ...
        <div className="flex h-16 items-center gap-3 border-b border-slate-700/60 px-5">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-100">AlertaOrbital</p>
            <p className="text-xs text-slate-500">Monitoramento via satélite</p>
          </div>
        </div>
